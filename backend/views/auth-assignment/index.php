            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Akses Akun</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="#!">Data Akses</a></li>
                        <li class="breadcrumb-item"><a href="#!">Halaman Akses</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    <p>
                        <?= Html::a('Berikan Akses', ['create'], ['class' => 'btn btn-success']) ?>
                    </p>
